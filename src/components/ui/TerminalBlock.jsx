...
const LINES = [
  { text: '→  init visa_research --dest="Canada" --visa="study_permit"', color: 'text-gray-400' },
  ...
  { text: '→  build_checklist --nationality="RW" --program="MSc"',      color: 'text-gray-400' },
  ...
  { text: '→  review_documents --upload="transcript.pdf"',              color: 'text-gray-400' },
...
export default function TerminalBlock({ autoStart = false }) {
  ...
  return (
    <div ref={ref} className="bg-[#070F1E] border border-white/8 rounded-xl overflow-hidden shadow-card">
      <div className="flex items-center gap-2 px-5 py-3.5 border-b border-white/6 bg-[#0D1526]/60">
